...
for k in range(1,9):
	numofdice = 20
	workbook = xlsxwriter.Workbook('result(dice)'+str(k)+'.xlsx')
	worksheet = workbook.add_worksheet()
	p = k
	q = k
	for m in range(1,numofdice+1):
		for n in range(1,numofdice+1):		
			...
			worksheet.write(n,m,round(win_times / win_total * 100,2))
