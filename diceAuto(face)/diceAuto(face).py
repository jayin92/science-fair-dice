...
for k in range(1,9):
	numofface = 20
	workbook = xlsxwriter.Workbook('result(face)'+str(k)+'.xlsx')
	worksheet = workbook.add_worksheet()
	m = k
	n = k
	for p in range(1,numofface+1):
		for q in range(1,numofface+1):
			...
			worksheet.write(q,p,round(win_times / win_total * 100,2))
